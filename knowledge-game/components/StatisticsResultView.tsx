...
const profileImg = require("@/assets/images/userSample.png");
  ...
  return (
    <View style={SRPStyles.main}>
      <View style={SRPStyles.profileContainer}>
        <Image style={SRPStyles.img} source={profileImg} />
